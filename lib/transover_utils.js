...
TransOver.formatTranslation = function(translation) {
  ...
  if (translation instanceof Array) {
    ...
    translation.forEach(function(pos_block) {
        formatted_translation += '<td class="fahm-vocalized rtl">' + pos_block.vocalized + '</td><td class="fahm-translation">' + pos_block.translation + '</td><td class="fahm-stem rtl">' + pos_block.stem + '</td><td class="fahm-type">' + pos_block.type + "</td>";
        ...
        if (options) {
          ...
          if (options.tam) formatted_translation += " ة";
        }
